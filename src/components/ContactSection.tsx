        ...
        >
          ...
          <div className="space-y-8">
            <motion.div variants={itemVariants}>
              ...
              <h3 className="text-4xl font-bold text-zinc-900 dark:text-zinc-100 sm:text-4xl mb-6">
                Mari Bekerja Sama
              </h3>
            ...
            <motion.div variants={itemVariants} className="space-y-6 pt-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${portfolioData.personal.email}`} className="text-lg font-bold text-zinc-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${portfolioData.personal.phone?.replace(/ /g, '')}`} className="text-lg font-bold text-zinc-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
          ...
          <motion.div variants={itemVariants} className="relative">
             ...
             <div className="rounded-2xl bg-white dark:bg-zinc-900/80 p-8 sm:p-10 border border-zinc-200 dark:border-white/10 shadow-2xl backdrop-blur-sm">
